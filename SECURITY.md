...
You can privately report a vulnerability [here](https://github.com/ETS57-bytes/Interstellar/security/advisories/new).

Alternatively, you can join our [Discord server](https://discord.gg/Nova), and open a ticket and let us know what the vulnerability is.
...
If you have Nova installed locally:
...
If you encounter any challenges while updating, feel free to reach out to our [support team](https://discord.gg/nova) for assistance.
